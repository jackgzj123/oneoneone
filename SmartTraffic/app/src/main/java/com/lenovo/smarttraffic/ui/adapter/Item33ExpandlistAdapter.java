...
public class Item33ExpandlistAdapter extends BaseExpandableListAdapter {

    private List<Chapter> mDatas;
    private LayoutInflater mInflater;
    private Context mContext;

    public Item33ExpandlistAdapter(List<Chapter> mDatas, Context mContext) {
        this.mDatas = mDatas;
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            view = mInflater.inflate(R.layout.item33_chapter,viewGroup,false);
            parentViewHolder = new ParentViewHolder();
            parentViewHolder.mTvName = view.findViewById(R.id.item33_chaptertv);
