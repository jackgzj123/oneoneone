...
public class Fragment5 extends Fragment {
    ...
    private void setYAxis() {
        ...
        axisLeft.setAxisMinimum(13000); // 最小值为0
        axisLeft.setAxisMaximum(20000); // 最大值为1200
    ...
    private void setChartData() {
        ...
        yVals1.add(new BarEntry(0f, 18880));
        yVals1.add(new BarEntry(1f, 18900));

        final List<BarEntry> yVals2 = new ArrayList<>();
        yVals2.add(new BarEntry(0f, 15555));
        yVals2.add(new BarEntry(1f, 15600));


        BarDataSet barDataSet1 = new BarDataSet(yVals1, "有违法");
        ...
        BarDataSet barDataSet2 = new BarDataSet(yVals2, "无违法");
