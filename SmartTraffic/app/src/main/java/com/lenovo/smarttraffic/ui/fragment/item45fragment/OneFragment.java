...
public class OneFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =inflater.inflate(R.layout.item45activity_onefragment,null);
        getActivity().getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        mCar1Distance = view.findViewById(R.id.item45activity_onefragment_car1);
        mCar2Distance = view.findViewById(R.id.item45activity_onefragment_car2);
        mCo2 = view.findViewById(R.id.item45activity_onefragment_CO2);
        mPm2 = view.findViewById(R.id.item45activity_onefragment_pm2);
        mShi = view.findViewById(R.id.item45activity_onefragment_shi);
        mWen = view.findViewById(R.id.item45activity_onefragment_wen);
